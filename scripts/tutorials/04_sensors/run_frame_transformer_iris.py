...
from isaaclab_assets.robots.iris_gimbal2 import IRIS_GIMBAL2_CFG  # isort:skip
...
def define_sensor() -> FrameTransformer:
    ...
    frame_transformer_cfg = FrameTransformerCfg(
        prim_path="/World/Robot/iris/body",
        target_frames=[
            FrameTransformerCfg.FrameCfg(prim_path="/World/Robot/iris/.*"),
...
def design_scene() -> dict:
    ...
    # -- Robot
    robot = Articulation(IRIS_GIMBAL2_CFG.replace(prim_path="/World/Robot"))
    # robot = Articulation(IRIS_GIMBAL2_CFG.replace(prim_path="/World/Robot"))
    # -- Sensors
