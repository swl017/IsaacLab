...
class CameraFrustrum:
    ...
    def draw_frustrum(self, camera_position, camera_orientation, camera_intrinsics: torch.tensor, zoom_level: torch.tensor, device='cpu'):
        self.camera_position = camera_position
        self.camera_orientation = camera_orientation
        self.camera_intrinsics = camera_intrinsics

        frustum_b = self.compute_camera_frustum_batched(camera_intrinsics, zoom_level, device=device)['far_corners']
