...
./isaaclab.sh -p source/isaaclab_tasks/isaaclab_tasks/direct/iris_ma5/randomization/tests/run_tests.py --test-verbose

# Run on CPU only
CUDA_VISIBLE_DEVICES="" ./isaaclab.sh -p source/isaaclab_tasks/isaaclab_tasks/direct/iris_ma5/randomization/tests/run_tests.py
```
