...
"""
Randomization module for iris_ma5 multi-agent environment.
...
Usage:
    ...
    randomizer = Randomizer(num_envs=100, num_agents=3, device=device, cfg=cfg)
...
For legacy gimbal-constraint-based randomization, import from the legacy submodule:
    ```python
    from isaaclab_tasks.direct.iris_ma5.randomization.legacy import (
        LegacyRandomizer,
