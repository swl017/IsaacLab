...
class CurriculumCfg:
    ...
    Step:    0k   20k   30k   40k   60k   80k  100k  130k  150k 170k 190k 200k
             |     |     |     |     |     |     |    |     |    |    |    |
    AgentVel:[──────────ramp──────────]full────────────────────────────────────
    Safety:  [────ramp────]full────────────────────────────────────────────────
    Tracking:[──────────────────ramp──────────────]full────────────────────────
    ...
    Starts after agent velocity ramp is partially complete (40k end),
    so the agent has learned tilt compensation before tracking fast targets.
    """

    moving_target_end_step: int = 120000
    """Step when target reaches maximum speed/maneuverability.

    Extended ramp (100k steps) gives more time to learn tilt-coupled tracking.
    """
