...
Usage:
    ./isaaclab.sh -p source/isaaclab_tasks/isaaclab_tasks/direct/iris_ma4/randomization/test_gimbal_pointing.py
"""
import argparse
...
from isaaclab_tasks.direct.iris_ma4.controller import GimbalStabilizer, GimbalStabilizerCfg
