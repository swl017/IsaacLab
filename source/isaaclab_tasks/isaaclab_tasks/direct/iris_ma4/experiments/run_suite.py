...
"""Run a full experiment suite (batch of named experiments).
...
Usage:
    ...
    ./isaaclab.sh -p .../experiments/run_suite.py --suite a1_delay_sweep \\
...
def main():
    ...
    for exp_name in suite.experiments:
        ...
        # Skip eval-only experiments (like baseline_greedy)
