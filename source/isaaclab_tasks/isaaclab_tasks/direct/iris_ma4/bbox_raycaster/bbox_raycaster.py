# file: bbox_raycaster.py
"""Main batched bounding box raycaster class with body-local occlusion detection."""
...
class BBoxRayCaster:
    ...
    def __init__(
        ...
        omni.log.info(
            f"BBoxRayCaster initialized with {num_envs} envs, {self.num_cameras} cameras, "
