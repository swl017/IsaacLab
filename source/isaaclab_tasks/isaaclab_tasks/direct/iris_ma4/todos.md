...
4. (Raised at 2026-01-30 23:00) Check initial state (especially gimbal pointing to the target and formation) and randomization is correct and respects curriculum and physical limits, like gimbal tilt limits, at reset.

5. (Raised at 2026-02-01 00:50) Gimbal joint_id inconsistant between set_joint_position and reading actual joint angles
    ```
    """ Debug logs """
