...
./isaaclab.sh -p source/isaaclab_tasks/isaaclab_tasks/direct/iris_ma4/delay_system_v2/tests/run_tests.py

# With verbose output
./isaaclab.sh -p source/isaaclab_tasks/isaaclab_tasks/direct/iris_ma4/delay_system_v2/tests/run_tests.py --test-verbose
```
...
```bash
# CPU only
CUDA_VISIBLE_DEVICES="" ./isaaclab.sh -p source/isaaclab_tasks/isaaclab_tasks/direct/iris_ma4/delay_system_v2/tests/run_tests.py

# Specific GPU
CUDA_VISIBLE_DEVICES=0 ./isaaclab.sh -p source/isaaclab_tasks/isaaclab_tasks/direct/iris_ma4/delay_system_v2/tests/run_tests.py
```
