...
def test_curriculum_cfg(results: TestResults):
    ...
    from isaaclab_tasks.direct.iris_ma4.curriculum import CurriculumCfg
...
def test_delay_pipeline(results: TestResults, device: torch.device):
    ...
    from isaaclab_tasks.direct.iris_ma4.delay_system_v2.delay_cfg import FieldDelayCfg, DistributionCfg
    from isaaclab_tasks.direct.iris_ma4.delay_system_v2.delay_pipeline import DelayPipeline
