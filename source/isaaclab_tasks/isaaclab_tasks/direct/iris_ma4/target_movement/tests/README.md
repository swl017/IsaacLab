...
Test suite for the target movement module that provides randomized target motion for the iris_ma4 multi-agent drone environment.
...
./isaaclab.sh -p source/isaaclab_tasks/isaaclab_tasks/direct/iris_ma4/target_movement/tests/run_tests.py

# With verbose output
./isaaclab.sh -p source/isaaclab_tasks/isaaclab_tasks/direct/iris_ma4/target_movement/tests/run_tests.py --test-verbose
```
...
```bash
# CPU only
CUDA_VISIBLE_DEVICES="" ./isaaclab.sh -p source/isaaclab_tasks/isaaclab_tasks/direct/iris_ma4/target_movement/tests/run_tests.py

# Specific GPU
CUDA_VISIBLE_DEVICES=0 ./isaaclab.sh -p source/isaaclab_tasks/isaaclab_tasks/direct/iris_ma4/target_movement/tests/run_tests.py
```
